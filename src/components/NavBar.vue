<template>
        ...
        <section  id="navbar" class="w-full">
            <header class="flex items-center h-20 mx-auto md:max-w-2xl lg:max-w-6xl ">
                 ...
                 <nav data-aos="fade-down"
                    ...
                    class="flex justify-between items-center w-full ">
                        ...
                        <span  @click="toggleMenu()" class="block text-[2rem] pr-8 lg:hidden lg:pr-0 hover:text-emerald-400">
           ...
           <div :class="`${isMenuOpen ? 'block' : 'hidden'} fixed top-0 right-0 z-50   w-full min-h-screen bg-teal-50 dark:bg-dark flex flex-col items-start  lg:hidden`">
               <font-awesome-icon @click="toggleMenu()" icon="fa-solid fa-xmark" class="px-8 pt-4  text-[3rem] self-end lg:hidden text-emerald-800  dark:text-white dark:focus:text-emerald-400 dark:hover:text-emerald-400" />
                <ul class="w-full flex flex-col items-center mt-10 gap-4 ">
                        <li  
