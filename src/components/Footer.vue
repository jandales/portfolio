<template>
        ...
        <section id="footer" class=" w-full text-center h-14">
            <div class="relative">
                <ul v-scrollanimation  class="flex gap-4  items-center justify-center">
            ...
            <div v-scrollanimation  class="pt-4 pb-8 max-w-max mx-auto  text-sm cursor-pointer hover:text-[orange]">Designed & Built by Jesus Andales</div>
        </section>
